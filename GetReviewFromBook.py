...
def getReview(options, driver):
    ...
    # linkUrlFile = openpyxl.load_workbook('H:\Programming\pyCharm\WebScrappingPython\AllBook.xlsx', data_only=True)
    linkUrlFile = openpyxl.load_workbook(r'C:\Users\EATL\PycharmProjects\WebScapping\AllBook.xlsx', data_only=True)
